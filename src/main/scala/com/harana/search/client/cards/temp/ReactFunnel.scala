...
@JSImport("@nivo/funnel", "Funnel")
@js.native
object ReactFunnel extends js.Object

@react object Funnel extends ExternalComponent {

  case class Props(data: js.Array[FunnelEntry],
                   width: Int,
                   height: Int,
                   labelColor: js.UndefOr[String | Color] = js.undefined,
  ...
  override val component = ReactFunnel
}

trait FunnelEntry extends js.Object {
  val id: String
  val value: Int
  val label: String
}
